...
class TestBaseLLMClient(unittest.TestCase):
    ...
    @patch('tinychat.llms.base.get_api_key')
    def test_api_key_setter_valid_key(self, mock_get_api_key):
        mock_get_api_key.return_value = 'test_api_key'
        client = BaseLLMClient(api_key_name='test_api_key_name')
        self.assertEqual(client.api_key, 'test_api_key')

    @patch('tinychat.llms.base.get_api_key')
    def test_api_key_setter_invalid_key(self, mock_get_api_key):
    ...
    @patch('tinychat.llms.base.get_api_key')
    def test_default_headers(self, mock_get_api_key):
        mock_get_api_key.return_value = 'some-api-key'
        client = BaseLLMClient(api_key_name='test_api_key_name')
        expected_headers = {
